...
import com.example.tracetogether.bluetooth.gatt.ACTION_DEVICE_PROCESSED
import com.example.tracetogether.bluetooth.gatt.CONNECTION_DATA
import com.example.tracetogether.bluetooth.gatt.DEVICE_ADDRESS
...
import com.example.tracetogether.services.BluetoothMonitoringService.Companion.blacklistDuration
import com.example.tracetogether.services.BluetoothMonitoringService.Companion.maxQueueTime
import com.example.tracetogether.services.BluetoothMonitoringService.Companion.useBlacklist
import java.util.*
...
class StreetPassWorker(val context: Context) {
    ...
    private fun prepare() {
        ...
        CentralLog.d(TAG, "Service UUID ${serviceUUID}")
        CentralLog.d(TAG, "characteristicV2 ${characteristicV2}")
    }
